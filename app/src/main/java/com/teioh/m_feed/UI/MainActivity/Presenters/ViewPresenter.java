...
public abstract class ViewPresenter implements HomePresenter {
    public final static String TAG = ViewPresenter.class.getSimpleName();
    ...
    protected ViewPresenterMapper mViewMapper;

    public ViewPresenter(ViewPresenterMapper map) {
        mViewMapper = map;
    }
    ...
    protected void updateMangaGridView(List<Manga> aMangaList) {
        if (mViewMapper.getContext() != null) {
            if (aMangaList != null) {
                ...
                if (!(this instanceof RecentPresenterImpl))
